...
public class MethodSecurityBuilder<TAppContext extends AppContext, TCallContext extends CallContext> {
	...
	private final ImmutableMethodSecurity.Builder<TAppContext, TCallContext> builder = ImmutableMethodSecurity
		.builder();
	...
	public MethodSecurityBuilder<TAppContext, TCallContext> authorization(
		SecurityCheck<TAppContext, TCallContext> authorization) {
	...
	public MethodSecurityBuilder<TAppContext, TCallContext> defineInputFieldsTypeSecurity(
		Consumer<TypeFieldsSecurityBuilder<TAppContext, TCallContext>> block) {
	...
	public MethodSecurityBuilder<TAppContext, TCallContext> defineOutputFieldsTypeSecurity(
		Consumer<TypeFieldsSecurityBuilder<TAppContext, TCallContext>> block) {
		Validate.notNull(block);
	...
	public MethodSecurityBuilder<TAppContext, TCallContext> defineInputFieldsObjectSecurity(
	...
	public MethodSecurityBuilder<TAppContext, TCallContext> defineOutputFieldsObjectSecurity(
		Consumer3<TAppContext, TCallContext, ObjectFieldsSecurityBuilder<TAppContext, TCallContext>> block) {
		Validate.notNull(block);
