...
public class MethodMetadataBuilder<TAppContext extends AppContext, TCallContext extends CallContext> {
	private final ImmutableMethodMetadata.Builder<TAppContext, TCallContext> builder = ImmutableMethodMetadata
		.builder();
	...
	/**
	 * Disable listing allowed fields in input/output. Can be used for reducing
	 * message size of huge lists.
	 */
